...
public class MangaHere extends BaseSearchAdapter {
	...
	void init(){
		server_address = "http://www.mangahere.com";
		name = "MangaHere";
	...
	public SearchResult search(String word, int page){
		...
		try {
			...
			String results = this.getGetData("http://www.mangahere.com/search.php?direction=&name_method=cw&name="+word+"&author_method=cw&author=&artist_method=cw&artist=&genres[Action]=0&genres[Adventure]=0&genres[Comedy]=0&genres[Doujinshi]=0&genres[Drama]=0&genres[Ecchi]=0&genres[Fantasy]=0&genres[Gender+Bender]=0&genres[Harem]=0&genres[Historical]=0&genres[Horror]=0&genres[Josei]=0&genres[Martial+Arts]=0&genres[Mature]=0&genres[Mecha]=0&genres[Mystery]=0&genres[One+Shot]=0&genres[Psychological]=0&genres[Romance]=0&genres[School+Life]=0&genres[Sci-fi]=0&genres[Seinen]=0&genres[Shoujo]=0&genres[Shoujo+Ai]=0&genres[Shounen]=0&genres[Shounen+Ai]=0&genres[Slice+of+Life]=0&genres[Sports]=0&genres[Supernatural]=0&genres[Tragedy]=0&released_method=eq&released=&is_completed=&advopts=1");
			
			int pos = results.indexOf("<div class=\"result_search\">");
			results = results.substring(pos);

			Pattern p = Pattern
			.compile("<a href=\"([^\"]+)/\" class=\"manga_info name_one\"[^>]*>([^<]+)");
